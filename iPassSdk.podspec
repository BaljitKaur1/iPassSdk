#
#  Be sure to run `pod spec lint iPassSdk.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Baljit" => "baljitkaur@csgroupchd.com" }
  # Or just: spec.author    = "Baljit"
  # spec.authors            = { "Baljit" => "baljitkaur@csgroupchd.com" }
  # spec.social_media_url   = "https://twitter.com/Baljit"
